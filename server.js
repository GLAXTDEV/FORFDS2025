...
const ADMIN_KEY = process.env.ADMIN_KEY || 'codeglaxt2516@';
...
app.listen(3000, () => {
    ...
    if (!ADMIN_KEY) console.warn('Administration désactivée : définissez la variable ADMIN_KEY avant de lancer le serveur.');
